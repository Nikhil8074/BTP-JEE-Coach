    ...
    return (
        <Card className="w-full relative overflow-hidden bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.5)] rounded-2xl group">
            ...
            <CardHeader className="border-b border-white/5 pb-6">
                ...
                <CardTitle className="text-xl md:text-2xl font-serif leading-relaxed text-white/95 tracking-wide">
            ...
            <CardContent className="space-y-8 pt-6">
                                ...
                                <div key={idx} className="relative group">
                                    ...
                                    >
                                        <div className={cn(
                                            ...
                                            isSelected ? "bg-violet-500 text-white" : "bg-white/10 text-white/50 group-hover:bg-white/20"
                                        )}>
                                            {label}
                                        </div>
                            ...
                            return (
                                <div 
                                    ...
                                    className={cn(
                                        ...
                                        isSelected 
                                            ? "bg-violet-600/20 border-violet-500/50 shadow-[0_0_20px_rgba(139,92,246,0.15)] ring-1 ring-violet-500/50" 
                                            : "bg-black/20 border-white/5 hover:bg-white/5 hover:border-white/10 opacity-90",
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        isSelected ? "bg-violet-500 text-white shadow-inner" : "bg-white/10 text-white/50 group-hover:bg-white/20"
                                    )}>
                                        {label}
                                    </div>
                                    <div className="text-lg text-white/90">
                ...
                {(question.type === "INTEGER" || question.type === "DECIMAL") && (
                    <div className="space-y-4 max-w-sm mx-auto">
                        <Label htmlFor="numerical-answer" className="text-white/70 uppercase tracking-widest text-xs font-bold text-center block mb-4">Enter Numerical Answer</Label>
                        <Input 
                            id="numerical-answer"
                            type="text" 
                            ...
                            disabled={isSubmitted}
                            className="text-center text-3xl p-8 bg-black/30 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-violet-500/50 rounded-xl font-mono shadow-inner"
                        />
                    </div>
                )}
            </CardContent>
                ...
                {!isSubmitted ? (
                    <div className="flex flex-col md:flex-row gap-4 justify-center md:items-center w-full">
                        <Button 
                            ...
                            className="w-full md:w-auto min-w-[250px] bg-white text-black hover:bg-white/90 font-bold py-6 text-lg rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.15)] transition-all"
                            disabled={
                        ...
                        <Button
                            ...
                            className="w-full md:w-auto text-white/50 hover:text-white hover:bg-white/10 font-bold py-6 px-8 rounded-xl transition-all"
                        >
                            Reveal Solution
                        </Button>
                    </div>
                    ...
                    <div className="w-full space-y-6 animate-in slide-in-from-top-4 duration-500">
                        {/* Status Alert Banner */}
                        <div className={cn(
                            "flex items-center justify-center gap-3 p-6 rounded-xl border border-white/10 shadow-lg text-xl font-bold tracking-wide backdrop-blur-md",
                            hasRevealed ? "bg-amber-500/10 text-amber-400 border-amber-500/20" : 
                        ...
                        {!isCorrect && !hasRevealed && (
                            <div className="p-5 bg-black/40 rounded-xl border border-white/5 flex flex-col md:flex-row items-center justify-center gap-4">
                                <span className="text-white/50 text-sm font-semibold uppercase tracking-widest">Correct Answer:</span>
                                <span className="font-mono text-2xl font-bold text-white bg-white/10 px-4 py-1 rounded-md">
                        ...
                        {hasRevealed && (
                            <div className="p-5 bg-amber-500/5 rounded-xl border border-amber-500/10 flex flex-col md:flex-row items-center justify-center gap-4">
                                <span className="text-amber-300/50 text-sm font-semibold uppercase tracking-widest">Correct Answer:</span>
                                <span className="font-mono text-2xl font-bold text-amber-300 bg-amber-500/10 px-4 py-1 rounded-md">
                                    {question.correctAnswer}
                                </span>
                            </div>
                        )}
                        ...
                        <div className="pt-4 space-y-4">
                            <Button 
                                ...
                                className="w-full bg-white/5 border-white/10 text-white hover:bg-white/10 hover:text-white font-bold py-6 rounded-xl transition-all"
                            >
                            ...
                            {showSolution && (
                                <div className="p-6 md:p-8 bg-black/40 rounded-xl border text-white/90 border-white/5 prose prose-invert prose-lg max-w-none shadow-inner animate-in fade-in slide-in-from-top-4 duration-500">
